                        ...
                        >
                          ...
                          <span
                            style={{
                              fontSize: "13px",
                              fontWeight: "600",
                              color: capturing && capturedCameraIndices.includes(index)
                                ? "#3b82f6"
                                : (galleryImagesByCamera[camera.label] || []).length >= captureCount
                                  ...
                                  : (galleryImagesByCamera[camera.label] || []).length > 0
                                    ? "#f59e0b"
                                    : "#6b7280",
                              backgroundColor: capturing && capturedCameraIndices.includes(index)
                                ? "#eff6ff"
                                : (galleryImagesByCamera[camera.label] || []).length >= captureCount
                                  ? "#d1fae5"
                                  : (galleryImagesByCamera[camera.label] || []).length > 0
                              ...
                              alignItems: "center",
                              gap: "6px",
                              border: capturing && capturedCameraIndices.includes(index)
                                ? "1.5px solid #93c5fd"
                                : (galleryImagesByCamera[camera.label] || []).length >= captureCount
                                  ? "1.5px solid #6ee7b7"
                                  : (galleryImagesByCamera[camera.label] || []).length > 0
                                    ? "1.5px solid #fcd34d"
                                    : "1.5px solid #e5e7eb",
                              boxShadow: capturing && capturedCameraIndices.includes(index)
