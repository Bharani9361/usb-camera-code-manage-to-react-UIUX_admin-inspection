...
class Report extends Component {
    ...
    backButton = () => {
        ...
        this.props.history.push("/inspectResult");
    ...
    render() {
        // pagination
        const { timeWise_filterdata, currentPage, itemsPerPage } = this.state;   // expandedRow, searchQuery,
                                    ...
                                    <Row className="d-flex flex-wrap justify-content-center justify-content-lg-between align-items-center gap-2 mb-2">
                                        ...
                                        <Col xs="12" lg="auto" className="text-center">
                                            <ButtonGroup>
                                                ...
                                                >
                                                    Total {"("} {this.state.okCount + this.state.notokCount + this.state.no_objCount + this.state.incorrect_obj} {")"}
                                                </Button>
                                                <Button className='btn btn-sm w-md text-center' color="primary"
                                                ...
                                                >
                                                    Incorrect Object {"("} {this.state.incorrect_obj} {")"}
                                                </Button>
                                            </ButtonGroup>
                                        </Col>
                                    </Row>
