...
class Inspection extends Component {
    ...
    APICall = async (event) => {
        ...
        axios.post('http://49.207.181.236:5000/Testing', formData, {
            headers: {
    ...
    getImage = (Image_path, type) => {
        ...
        let baseurl = 'http://49.207.181.236:8000/'
    ...
    render() {
        //const webcamRef = webcamRef.webcam.getScreenshot();
