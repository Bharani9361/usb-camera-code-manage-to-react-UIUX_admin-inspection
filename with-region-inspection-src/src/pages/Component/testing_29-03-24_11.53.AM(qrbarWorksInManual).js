...
class Inspection extends Component {
    ...
    componentDidMount = () => {
        ...
        this.barcodeInfo(v_id, inspection_type)
        ...
        try {
            urlSocket.post('/objectDetectionOnly', formData, {
                ...
                .then(response => {
                    ...
                    this.setState({ res_message: response.data[0].detection_result, showstatus: true });
                    if(response.data[0].detection_result === "Object Detected") {
                        this.setState({comp_found: 2});
                    } else {
                        this.setState({comp_found: 1});
                    }
                    ...
                    setTimeout(() => {
                        ...
                        { mode: 'no-cors' })
                            ...
                            if(this.state.barcode_data === null || this.state.barcode_data === undefined) {
                                this.cont_apiCall();
                            } else {
                                this.setState({
                                    // showstatus: false,
    ...
    barcodeInfo = (comp_id, inspection_type) => {
        try {
