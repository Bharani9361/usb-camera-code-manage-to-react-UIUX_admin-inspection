...
import WebcamCapture from "./WebcamCapture";
import { DEFAULT_RESOLUTION } from "../Component/cameraConfig";
import PropTypes from "prop-types";

const ZoomableWebcamViewer = forwardRef(({ zoomVal = 1, centerVal = { x: 0.5, y: 0.5 } }, ref) => {
...
ZoomableWebcamViewer.displayName = "ZoomableWebcamViewer"; // Set display name for debugging
ZoomableWebcamViewer.propTypes = {
    zoomVal: PropTypes.any,
    centerVal: PropTypes.any,
};
