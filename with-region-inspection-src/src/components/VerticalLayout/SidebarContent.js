...
//     const visualInspection = ['/inspect'];
//     const inspectionResultDetails = ['/timewise']
...
//         break;
//       }
//       else if (visualInspection.includes(this.props.location.pathname)) {
//         matchingMenuItem = items[0];
//         break;
//       }
//       else if (inspectionResultDetails.includes(this.props.location.pathname)) {
...
//                   to="/crudcomponent"
//                   className={
//                     show_sidebar === 'false' ? "sidebar-link" : "disableSidebar sidebar-link"
//                   }
...
//                   </div>
//                   <span>Inspection Result Details</span>
//                 </NavLink>
//               </li>
...
//             {
//               // Hide SidebarContent in Testing Page (/inspect)
//               // <>
//               //   <li>
//               //     <Link 
//               //       to="/crudcomponent" 
//               //       className={
//               //         show_sidebar === 'false' ? "" : "disableSidebar"
//               //       }
//               //     >
...
//             {/* <li>
//                 <Link to="/prdct_report" className="">
...
class SidebarContent extends Component {
  ...
  initMenu() {
    ...
    const highlightMapping = {
      '/inspecttestingstage': 0,
      '/inspectiontestingstagesequential': 0,
      '/sequential': 2,
      '/remote_single_stg': 2,
      '/remote_stg': 2,
      '/admin_accuracy_single': 2,
      '/admin_accuracy_multi': 2,
      '/Admin_accuracy_image': 2,
      '/Profile_sequence': 2,
      '/Profile_non_single': 2,
      '/Profile_non_multi': 2
    };
    ...
    if (highlightMapping[this.props.location.pathname] !== undefined) {
      const index = highlightMapping[this.props.location.pathname];
      matchingMenuItem = items[index];
    } else {
      for (let i = 0; i < items.length; ++i) {
        const path = items[i].pathname;
        ...
        if (this.props.location.pathname === path) {
          ...
          inspectionResultDetails.includes(this.props.location.pathname)
        ) {
          matchingMenuItem = items[1];
          break;
        }
  ...
  render() {
    ...
    const disablePaths = [
      '/inspecttestingstage',
      '/inspectiontestingstagesequential',
      '/sequential',
      '/remote_single_stg',
      '/remote_stg',
      '/admin_accuracy_single',
      '/admin_accuracy_multi',
      '/Admin_accuracy_image',
      '/Profile_sequence',
      '/Profile_non_single',
      '/Profile_non_multi'
    ];

    const isDisabled = disablePaths.some(path => currentPath.includes(path));
            ...
            <ul className='metismenu list-unstyled' id='side-menu'>
              ...
              <li>
                <NavLink
                  to='/crudcomponent'
                  className={
                    isDisabled ? 'disableSidebar sidebar-link' : 'sidebar-link'
                  }
                  onClick={e => {
                    // Prevent navigation if sidebar is disabled
                    if (isDisabled) {
                      e.preventDefault();
                    }
                  }}
