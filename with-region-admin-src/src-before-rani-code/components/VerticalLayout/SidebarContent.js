...
const SidebarContent = (props) => {
  ...
  const initMenu = () => {
    ...
    const pcConfigList = ['/pcConfigList'];
    ...
    for (let i = 0; i < items.length; ++i) {
      if (location.pathname === items[i].pathname) {
       ...
       else if (pcConfigList.includes(location.pathname)) {
        matchingMenuItem = items[1];
        break;
      }
      else if (configuration.includes(location.pathname)) {
        matchingMenuItem = items[2]; // Configuration Details is second
        break;
      }
      else if (componentInfo.includes(location.pathname)) {
        matchingMenuItem = items[3]; // Component Info is third
        break;
      }
      else if (logInfo.includes(location.pathname)) {
        matchingMenuItem = items[4]; // Log is fourth
        break;
      }
      else if (stationInfo.includes(location.pathname)) {
        matchingMenuItem = items[5 ]; // Station Info is fifth
        break;
      }
      else if (stationReport.includes(location.pathname)) {
        matchingMenuItem = items[6]; // Station Report is sixth
        break;
      }
    }
    if (matchingMenuItem) {
