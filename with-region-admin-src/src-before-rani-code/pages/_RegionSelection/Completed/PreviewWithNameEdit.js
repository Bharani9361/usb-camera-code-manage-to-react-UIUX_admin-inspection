...
const PreviewWithNameEdit = () => {
    ...
    }, [cvLoaded, rectangles, selectedRectangleIndex, editingRectangleIndex, selecting, capturedImage]);
            ...
            </div>
            {
                ...
                >
                    {rectangles.map((rectangle, id_rect) => (
                        ...
                        // <div>
                        //     {`${rectangle.name} - (${rectangle.x}, ${rectangle.y}, ${rectangle.width}, ${rectangle.height}, ${rectangle.x + rectangle.width}, ${rectangle.y + rectangle.height})`}
                        // </div>
...
export default PreviewWithNameEdit;
// while copying this 'Imported function path' will be changed.