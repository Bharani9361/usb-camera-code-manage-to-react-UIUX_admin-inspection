...
export default class profileRatioHandler extends Component {
    ...
    fetchData = async () => {
        let choosen_prof = JSON.parse(sessionStorage.getItem("computeProfData"));

        // let ref_img_path = await this.getRefImage(choosen_prof);
        let res_data = await this.getRefImage(choosen_prof);

        console.log('data79 ', choosen_prof, choosen_prof.qrbar_check, choosen_prof.qrbar_check_type, res_data);
        this.setState({ regionselection: choosen_prof.regionselection })
    ...
    objectDetectionOnly = async () => {
        ...
        console.log('data448 ', choosen_prof.regionselection, this.state.regionselection)
                                ...
                                urlSocket.post('/overall_result_profile',
                                    {
                                        ...
                                        "regionselection": this.state.regionselection,
                                    },
                                    { mode: 'no-cors' })
                                    .then(async detection => {
                                        ...
                                        console.log('201sample_count, obj_count + 1 ', detection.data[0], sample_count, obj_count + 1)
                                        if (this.state.regionselection) {
                                            const retrievedRectangles = detection.data[0].rectangles.map((rect) => ({
                                                x: rect.rectangles.coordinates.x,
                                                y: rect.rectangles.coordinates.y,
                                                height: rect.rectangles.coordinates.height,
                                                width: rect.rectangles.coordinates.width,
            ...
            <div className='page-content'>
                <Container fluid={true} style={{ minHeight: '100vh', background: 'white' }}>
                    <div className='d-flex justify-content-between align-items-center'>
                        <Button className='my-3' color='primary' onClick={() => this.abort()}>Abort</Button>
                        {/* <h5>
                            Component Name: {choosen_prof.comp_name}
                        </h5> */}
                    </div>
                    ...
                    <Row>
                        ...
                        <div className="ms-3 d-flex align-items-start justify-content-start">
                            ...
                            {/* <div className='ms-5'>
                                <p style={{ fontWeight: 'bold' }}>Inspection Type</p>
                                <Radio.Group onChange={this.handleManualAuto} value={this.state.inspection_type} disabled={this.state.set_values}>
                                    <Radio value="Manual">Manual</Radio>
                                    <Radio value="Auto">Auto</Radio>
                                </Radio.Group>
                                {this.state.inspection_type === 'Auto' && (
                                    <div className='mt-2 d-flex align-items-center'>
                                        <p style={{ fontWeight: 'bold', margin: '0', whiteSpace: 'pre' }}>Countdown (in sec):  </p>
                                        <InputNumber
                                            min={1}
                                            max={100}
                                            defaultValue={this.state.timerValue}
                                    ...
                                    <Row>
                                        <Col lg={8} md={8} xs={8} className="mx-auto">
                                            <Row>
                                                ...
                                                {
                                                    ref_img_path && <Col>
                                                        <img style={{ height: 'auto', width: '100%', borderRadius: '2rem' }} src={this.getImage(ref_img_path)} />
                                                    </Col>
                                                }
                                            </Row>
                                        </Col>
                                        ...
                                        <Row className="tdCntStl">
                                            <div className="table-responsive sdTblFntSz" style={{ paddingTop: '10px' }}>
                                                <Table className="table" style={{
                                                    ...
                                                    <tbody>
                                                        {/* <tr>
                                                            <td style={{ fontWeight: 'bold' }}>Total Samples</td>
                                                            <td style={{ fontWeight: 'bold' }}>{this.state.sample_count}</td>
                                                        </tr> */}
                                                        <tr>
                                            ...
                                            <div>
                                                <div style={{ position: 'relative', width: '100%', height: 'auto' }}>
                                                    ...
                                                    <canvas
                                                        ...
                                                        height={480}
                                                        style={{
                                                            display: (!(this.state.regionselection && this.state.output_Rect)) && 'none',
                                                            position: 'absolute',
                                                            top: 0,
                                                            left: 0,
                                                            width: '100%',
                                                    ...
                                                    />
                                                    {/* {this.state.regionselection && this.state.output_Rect &&
                                                        <div style={{ position: 'relative', top: 0, left: 0 }}>
                                                            {this.state.res_img && this.state.output_Rect &&
                                                                <>
