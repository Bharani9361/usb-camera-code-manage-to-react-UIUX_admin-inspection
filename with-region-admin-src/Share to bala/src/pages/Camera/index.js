...
class Camera extends Component {
  ...
  APICall = async (event) => {
    ...
    formData.append('CompName', component_name);
    formData.append('CompCode', component_code);
    console.log(compdata)
                       ...
                       <Row>
                          {
                            this.state.Datasets.map((data, index) => (
                              this.getImage(data.Image_path) !== "" &&
                              <Col key={index}>
                                <img src={this.getImage(data.Image_path)} style={{ width: 100, height: 'auto' }} />
                              </Col>
                      ...
                      <CardBody>
                        <div style={{ textAlign: "center" }} >
                          <Button color="primary"
                            className="w-md m-1"
                            onClick={() => this.trainClick()}>TRAIN REAL COMPONENT</Button>
                        </div>
                      </CardBody>
                    </Card>
