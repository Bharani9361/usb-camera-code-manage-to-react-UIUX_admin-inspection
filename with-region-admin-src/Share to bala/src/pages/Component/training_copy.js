...
class Training extends Component {
    ...
    componentDidMount = () => {
        ...
        if (datasets === undefined) {
            this.setState({ component_name: component_name1, component_code: component_code1, isEdit: false })
        }
        else {
            this.setState({ component_name: component_name1, component_code: component_code1, datasets, isEdit: true })
        }
                                        ...
                                        <Col lg={6}>
                                                            ...
                                                            <Row>
                                                                {
                                                                    this.state.real_ === this.state.showContent &&
                                                                        ...
                                                                        this.state.ImageData.map((data, index) => (
                                                                            ...
                                                                            <Col className="mt-2" key={index} style={{background:'green'}}>
                                                                                            ...
                                                                                            this.state.ImageData.map((data, index) => (
                                                                                                ...
                                                                                                <Col className="mt-2" key={index}>
                                                                                                    {/* <img src={this.getImage(data.Image_path, data.type)} style={{ width: 100, height: 'auto' }} /> */}
                                                                                                        <Image width={100} src={this.getImage(data.Image_path, data.type)} />
                                                                        ...
                                                                        this.state.showCamera ?
                                                                            <Row className="mt-3 justify-content-center">
                                                                                    ...
                                                                                    Label Name:{this.state.showContent}  </label>
                                                                                {
                                                                                    ...
                                                                                    this.state.ImageData.map((datas, index) => (
                                            ...
                                            {/* {
                                                this.state.real_ !== "" && this.state.isGallery ? (
                                                    <Lightbox
                                                        mainSrc={this.state.ImageData[this.state.photoIndex]}
                                                        nextSrc={this.state.ImageData[(this.state.photoIndex + 1) % this.state.ImageData.length]}
                                                        prevSrc={
                                                            this.state.ImageData[(this.state.photoIndex + this.state.ImageData.length - 1) % this.state.ImageData.length]
                                                        }
                                                        enableZoom={false}
                                                        ...
                                                        onMovePrevRequest={() =>
                                                            this.setState({
                                                                photoIndex:
                                                                    (this.state.photoIndex + this.state.ImageData.length - 1) % this.state.ImageData.length,
                                                            })
                                                        }
                                                        onMoveNextRequest={() =>
                                                            this.setState({
