                ...
                <div>
                    <div style={{ position: 'relative' }}>
                        <canvas
                            ...
                            width={640}
                            height={480}
                            onMouseDown={isResizing ? handleMouseDownResize : handleMouseDown}
                            onMouseMove={isResizing ? handleMouseMoveResize : handleMouseMove}
                            onMouseUp={isResizing ? handleMouseUpResize : handleMouseUp}
                        />
