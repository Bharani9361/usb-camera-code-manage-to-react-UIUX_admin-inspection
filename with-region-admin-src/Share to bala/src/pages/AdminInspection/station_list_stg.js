                                                        ...
                                                        <div className="d-flex gap-1 align-items-center" style={{ cursor: "pointer" }}>
                                                            ...
                                                            {station.status !== "Inactive" && (
                                                                <>
                                                                    ...
                                                                    <Button color="primary" className="btn btn-sm" onClick={() => manage_train_Comp(station)} id={`Training-${station._id}`}>Assigning To Training Mode</Button>
                                                                    <UncontrolledTooltip placement="top" target={`Training-${station._id}`}>Assigning To Training Mode</UncontrolledTooltip>
                                                                </>
