...
const StageModelCreation = () => {
    ...
    useEffect(() => {
        if (cameraList && cameraList.length > 0) {
            console.log('jjjjjjjj', cameraList)
    ...
    // useEffect(() => {
    //     if (cameraList && cameraList.length > 0) {
    //         setSelectedCameraLabel(cameraList[0].label);
    //     }
    // }, [cameraList]);
    ...
    const handleDeleteSelectedImages = async (img_path) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                imgDeletion(img_paths_to_delete);
            }
        });
    };
                                                                                ...
                                                                                {cameraList.length > 1 && (
                                                                                    <div className="mb-3">
                                                                                        <div className="d-flex flex-wrap gap-2">
                                                                                            {console.log("selectedCameraLabelffffffffff", selectedCameraLabel, cameraList)}
