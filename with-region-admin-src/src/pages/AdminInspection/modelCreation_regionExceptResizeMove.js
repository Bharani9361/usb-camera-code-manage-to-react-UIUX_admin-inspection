...
class modelCreation extends Component {
    ...
    handleMouseDown = (e) => {
        ...
        if(zoom == 1) {
            ...
            // console.log('handleMouseDown** ', ((e?.clientX  - rect.left) * (canvas.width / rect.width) / zoom));
        } else {
            x = (e?.clientX - rect.left) * scaleX;
            y = (e?.clientY - rect.top) * scaleY;
            // console.log('handleMouseDown** ', ((e?.clientX  - rect.left) / zoom));
        }
    ...
    handleResizeStart = (e, index) => {
        ...
        const onMouseUp = () => {
            ...
            this.resizingRectIndexRef.current = null; // Reset the resizing rectangle index
        };
