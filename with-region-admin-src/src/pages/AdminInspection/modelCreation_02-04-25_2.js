// modelCreation.js
// backup which has 
// 1. image gallery for adding multiple images for ML algorithm (SIFT),
// 2. similarity adjustment for SIFT
...
class modelCreation extends Component {
    ...
    getModelCreation = async (compModelVInfo) => {
        try {
            ...
            //     console.log('imageSrc in regionSelection')
            ...
            //         colour: rect.colour
            //     }));
            //     console.log('called *********************', retrievedRectangles[2])
            //     const image1 = compModelVerInfo.datasets[0];
            //     const imageurl = this.getImages(image1);
        ...
        return (
            <>
                <div className='page-content'>
                                                                            ...
                                                                            <td style={{ backgroundColor: "white", fontSize: '18px' }} >
...

                                                                                {
                                                                                    ...
                                                                                    !showTrainingINProgs && !isInactive && !isTrainingInProgress && (
                                                                                        isTrainingCompleted ? (
                                                                                            <Button className='btn btn-sm' color='success' onClick={() => this.adminAccTest(data)}>
                                                                    ...
                                                                    <Row className="col-lg-6">
                                                                        ...
                                                                        <div className='loading-content'>
                                                                            ...
                                                                            <td style={{ backgroundColor: "white" }}>
                                                                                <Button onClick={() => this.tog_xlarge()} className="btn btn-primary btn-sm" data-toggle="modal" data-target=".bs-example-modal-xl">Log</Button>
                                                                            </td>
                                                                        </tr>
                                                                    );
                                                                })}
                    ...
                    {/* Modal 3 - (disabled - includes region selection)*/}
                    {
                        modal_xlarge1 &&
                                                        ...
                                                        (
                                                            <div className='ms-3'>
                                                                ...
                                                                </InputGroup>
                                                                {
                                                                    ...
                                                                    <Label className=' my-auto' style={{ color: 'red' }}>{`* Rectangle Name Already Exists `}</Label>
                                                                }
                                                            </div>
                                                        )}
                                                </div>
