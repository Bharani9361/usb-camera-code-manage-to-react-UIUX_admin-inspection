...
const AccuracyModal = ({
    ...
    console.log('sample_count15', config,
        sample_count,
        manual_abort,
        time_elapsed,
        res_mode,
    ...
    const handleOk = () => {
        console.log("isFullAccuracyisFullAccuracyisFullAccuracyisFullAccuracy")
        const train_acc_global = _.mean(Object.values(train_accuracy));
        const isFullAccuracy = train_acc_global === 100;
        console.log('isFullAccuracyisFullAccuracy', isFullAccuracy)
        setShow(false);
