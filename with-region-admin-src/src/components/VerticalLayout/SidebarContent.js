...
const SidebarContent = (props) => {
  ...
  const initMenu = () => {
    ...
    // Fixed arrays - added missing routes and fixed typo
    const cameraConfiguration = ['/Camera-setposition'];
    const configuration = ['/config'];
    const componentInfo = ['/comp_info', '/manageModel', '/modelVerInfo', '/modelCreation', '/comp_log', '/adminAccTesting', '/modelAccuracyTesting', '/profileCreation', '/station_data'];
    const logInfo = ['/log'];
    const stationInfo = ['/station_list', '/entry_scrn'];
    const stationReport = ['/station_report', '/time_wise_report'];
    ...
    for (let i = 0; i < items.length; ++i) {
      ...
      else if (cameraConfiguration.includes(location.pathname)) {
        matchingMenuItem = items[0]; // Camera Configuration is first
        break;
      }
      else if (configuration.includes(location.pathname)) {
        matchingMenuItem = items[1]; // Configuration Details is second
        break;
      }
      else if (componentInfo.includes(location.pathname)) {
        matchingMenuItem = items[2]; // Component Info is third
        break;
      }
      else if (logInfo.includes(location.pathname)) {
        matchingMenuItem = items[3]; // Log is fourth
        break;
      }
      else if (stationInfo.includes(location.pathname)) {
        matchingMenuItem = items[4]; // Station Info is fifth
        break;
      }
      else if (stationReport.includes(location.pathname)) {
        matchingMenuItem = items[5]; // Station Report is sixth
        break;
      }
    }
    if (matchingMenuItem) {
  ...
  const disableSidebarRoutes = ["/adminAccTesting", '/modelAccuracyTesting', '/profile-ratio-handler-stg', '/modelCreation', '/profile-ratio-handler-stg'];
  const shouldDisableSidebar = disableSidebarRoutes.includes(currentPath);

  return (
    <React.Fragment>
      <SimpleBar 
        className={`sidebar-container ${shouldDisableSidebar ? "sidebar-disabled" : ""}`} 
        ref={refDiv}
      >
        <div id="sidebar-menu">
          <ul 
            ...
            id="side-menu" 
            tabIndex={shouldDisableSidebar ? -1 : 0}
          >
            <li className="menu-title">{props.t("Menu")}</li>

            <li>
              <NavLink
                to="/Camera-setposition"
                exact
                className="sidebar-link"
                onClick={e => shouldDisableSidebar && e.preventDefault()}
              >
                <div className="sidebar-icon-container">
                  <i className="bx bx-camera sidebar-icon"></i>
                </div>
             ...
             {/* <li>
              ...
              >
                <div className="sidebar-icon-container">
                  <i className="bx bx-desktop sidebar-icon"></i>

                </div>
                <span>Pc Config List</span>
              </NavLink>
            </li> */}
            ...
            <li>
              ...
              >
                <div className="sidebar-icon-container">
                  <i className="bx bx-cog sidebar-icon"></i>
                </div>
            ...
            <li>
              <NavLink
                ...
                className="sidebar-link"
                onClick={e => shouldDisableSidebar && e.preventDefault()}
                onClickCapture={loadPages}
              >
                <div className="sidebar-icon-container">
                  <i className="mdi mdi-tools sidebar-icon"></i>
                </div>
            ...
            <li>
              ...
              >
                <div className="sidebar-icon-container">
                  <i className="bx bxs-report sidebar-icon" />
                </div>
                <span>Log</span>
              </NavLink>
            </li>
            ...
            <li>
              ...
              >
                <div className="sidebar-icon-container">
                  <i className="bx bx-user-circle sidebar-icon"></i>
                </div>
            ...
            <li>
              ...
              >
                <div className="sidebar-icon-container">
                  <i className="bx bxs-report sidebar-icon"></i>
                </div>
...
//               </li> */}
//       {/* <li>
//                 <Link to="/connected_device" className="">
//                   <i className="bx bx-cog" />
//                   <span>Device Info</span>
//                 </Link>
//               </li> */}
//       {/* <li>
//                 <Link to="/camera_preview" className="">
//                   <i className="bx bx-cog" />
...
//       </li>
//       <li>
//         <Link to="/station_list" className="">
//           <i className="bx bx-calendar" />
//           <span>Station Info</span>
//         </Link>
//       </li>
//       <li>
//         <Link to="/station_report" className="">
//           <i className="bx bx-calendar" />
//           <span>Station Report</span>
//         </Link>
//       </li>
//       {/* <li>
//                 <Link to="/model-info-config" className="">
//                   <i className="bx bx-calendar" />
//                   <span>Model Configuration</span>
//                 </Link>
//               </li> */}
//       {/* <li>
//                 <Link to="/region_selection" className="">
//                   <i className="bx bx-calendar" />
...
//     const configuratino = ['/config'];
//     const componentInfo = ['/manageModel', '/modelVerInfo', '/modelCreation', '/comp_log', '/adminAccTesting', '/modelAccuracyTesting', '/profileCreation', '/station_data'];
//     const logInfo = ['/log']
//     const stationInfo = ['/station_list', '/entry_scrn']
//     const stationReport = ['/station_report', '/time_wise_report']
...
//         break;
//       }
//       else if (componentInfo.includes(this.props.location.pathname)) {
//         matchingMenuItem = items[1];
//         break;
//       }
//       else if (logInfo.includes(this.props.location.pathname)) {
//         matchingMenuItem = items[2];
//         break;
//       }
//       else if (stationInfo.includes(this.props.location.pathname)) {
//         matchingMenuItem = items[3];
//         break;
//       }
//       else if (stationReport.includes(this.props.location.pathname)) {
...
//      const disableSidebarRoutes = ["/adminAccTesting",'/modelAccuracyTesting','/profile-ratio-handler','/modelCreation'];
...
//         <SimpleBar className={`sidebar-container ${shouldDisableSidebar ? "sidebar-disabled" : ""}`} ref={this.refDiv}>
//           <div id="sidebar-menu">
//             <ul className="metismenu list-unstyled" id="side-menu" tabIndex={shouldDisableSidebar ? -1 : 0}>
//               <li className="menu-title">{this.props.t("Menu")}</li>

//                 <li>
//                 <NavLink
//                   // to={this.props?.show_sidebar ? "#" : "/dashboard"}
//                   to="/Camera-setposition"
//                   className={`sidebar-link`}
//                   onClick={e => shouldDisableSidebar && e.preventDefault()}
//                 >
...
//               <li>
//                 <NavLink
//                   // to={this.props?.show_sidebar ? "#" : "/comp_admin"}
//                   to="/comp_info"
//                   className={`sidebar-link`}
                  
//                  onClick={e => shouldDisableSidebar && e.preventDefault()}
//                 onClickCapture={this.loadPages}
//                 // className={`sidebar-link`}
//                 >
//                   <div className="sidebar-icon-container">
//                     <i className="mdi mdi-tools sidebar-icon"></i>
...
//               <li>
//                 <NavLink
//                   // to={this.props?.show_sidebar ? "#" : "/station_list"}
//                   to="/log"
//                   className={`sidebar-link`}
//                   onClick={e => shouldDisableSidebar && e.preventDefault()}
//                 >
...
//               <li>
//                 <NavLink
//                   // to={this.props?.show_sidebar ? "#" : "/station_report"}
//                   to="/station_list"
//                   className={`sidebar-link`}
//                   onClick={e => shouldDisableSidebar && e.preventDefault()}
//                 >
...
//               <li>
//                 <NavLink
//                   // to={this.props?.show_sidebar ? "#" : "/sensor-list"}
//                   to="/station_report"
//                   className={`sidebar-link`}
//                   onClick={e => shouldDisableSidebar && e.preventDefault()}
//                 >
